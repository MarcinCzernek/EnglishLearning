...
public class RecordLaunchActivity2 extends AppCompatActivity {
    ...
    //zmienna na stałe pozwolenia na odtwarzanie
    ...
    private void playAudio() {
        // Używam klasę media player do grania nagranego dzwięku
        ...
        try {
            ...
            //przygotuj media player
            mediaPlayer.prepare();

            // startuj media player.
            mediaPlayer.start();
            status.setText("Odtwarzanie nagrania");
    ...
    private void stopPlaying() {
        ...
        mediaPlayer.release();
        mediaPlayer = null;
        status.setText("Zatrzymanie odtwarzania nagrania");
    }
    ...
    private void RequestPermission() {
        ActivityCompat.requestPermissions(RecordLaunchActivity2.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, RECORD_AUDIO_PERMISSION);
    }
